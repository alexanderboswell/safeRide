...
### Adjustable settings ###
 ...
 #### Sensitivity options ####
 For sound classification, a user can adjust the sensitivity of sound recogniziation. Changing this option allows a user to recieve more or less notifications based on the context they are currently riding in.
